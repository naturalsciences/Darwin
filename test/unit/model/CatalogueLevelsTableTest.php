...
$t->is($levels->count(),78,'There are a good number of levels');
$t->is($levels[76]->getLevelName(),'sub group','Name of last level is well "sub group"');
...
$t->is($levels->count(),5,'There are "4" results in mineralogy');
...
$t->is($levels[0]->getLevelName(),'division','The first and only one is "series"');