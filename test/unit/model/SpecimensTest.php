...
$t->is( $specimens[4]->getName(), '-', 'This specimen has the formated name: "-"');
$t->is( $specimens[2]->getName(), 'Falco Peregrinus Tunstall, 1771', 'The previous specimen has the formated name: "Falco Peregrinus Tunstall, 1771"');
$specimens[2]->Taxonomy->setExtinct(true);
$specimens[2]->Taxonomy->save();
$t->is( $specimens[2]->getName(), 'Falco Peregrinus Tunstall, 1771 †', 'Now this specimen with a taxon definition set at extinct has the formated name: "Falco Peregrinus Tunstall, 1771 †"');
