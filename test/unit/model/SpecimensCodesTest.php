...
$specimen = Doctrine::getTable('SpecimenSearch')->findOneByTaxonRef($taxon->getId());

$code = new Codes;
$code->setReferencedRelation('specimens');
$code->setRecordId($specimen->getSpecRef());
...
$specCodes = Doctrine::getTable('Codes')->getCodesRelated('specimens', $specimen->getSpecRef());
$specimen->SpecimensCodes = $specCodes;

$t->is(count($specimen->SpecimensCodes), 4, '"4" codes available for specimen "'.$specimen->getSpecRef().'"');
