...
$mineralo = Doctrine::getTable('Mineralogy')->findByCodeLimited('4', 10);
$t->info('findByCodeLimited($code, $limit)');
$t->is($mineralo->count(), 6, 'Got the right number of units with code begining with 4');
$mineralo = Doctrine::getTable('Mineralogy')->findByCodeLimited('4', 2);
$t->info('findByCodeLimited($code, 2)');
...
$mineralo->save();
$mineralo = Doctrine::getTable('Mineralogy')->findByCodeLimited('6', 10);
$t->info('findByCodeLimited($code, $limit)');
