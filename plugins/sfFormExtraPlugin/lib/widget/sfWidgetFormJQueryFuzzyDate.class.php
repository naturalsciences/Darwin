...
/**
 * sfWidgetFormJQueryFuzzyDate represents an input widget followed by a date picker rendered by JQuery.
 *
 * This widget needs JQuery and JQuery UI to work.
 *
 * @package    symfony
 * @subpackage widget
 * @author     Paul-Andre Duchesne <Paul-Andre.Duchesne@sciencesnaturelles.be>
 */
class sfWidgetFormJQueryFuzzyDate extends sfWidgetFormInput
{
  /**
...
<script type="text/javascript">
  ...
  function wfd_%s_check_correct_date()
  {
    return {};
  }
