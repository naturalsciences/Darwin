  <tr id="<?php echo $form['user_ref']->getValue() ;?>">
    ...
    <td>
      <div>    
	    <a id="subcol" class='set_rights' href="<?php echo url_for('collection/rights?user_ref='.$form['user_ref']->getValue().'&collection_ref='.$ref_id);?>" name="<?php echo __('sub collections') ; ?>"><?php echo __('On sub collections...');?></a>
	   </div>	    
    </td>
    <td>
