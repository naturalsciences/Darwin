...
<?php echo form_tag('lithostratigraphy/'.($form->getObject()->isNew() ? 'create' : 'update?id='.$form->getObject()->getId()), array('class'=>'edition', 'enctype'=>'multipart/form-data'));?>
...
$(document).ready(function () {
  ...
  $('#lithostratigraphy_name').autocomplete({
      minLength: 3,
      source: function( request, response ) {
        $.getJSON('<?php echo url_for('catalogue/completeName?table=lithostratigraphy');?>', {term : request.term }, function( data) {
