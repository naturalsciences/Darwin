    ...
    <tr>
      <td colspan='5'>
        ...
        <div class="relatedFile">
          ...
          <a href="<?php echo url_for('maintenances/addRelatedFiles'.($form->getObject()->isNew() ? '': '?id='.$form->getObject()->getId()));?>/num/" id="add_file" class="hidden"></a>
...
<script  type="text/javascript">
  $(document).ready(function () {
    $('.Add_related_file').change(function()
    {
      ...
      form.attr('action','<?php echo url_for("loan/insertFile?table=collection_maintenance".($form->getObject()->isNew()?"":"&id=".$form->getObject()->getId())) ;?>') ;
