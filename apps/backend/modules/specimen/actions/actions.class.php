...
class specimenActions extends DarwinActions
{
  ...
  */
  ...
  {
    $this->forward404Unless($this->specimen = Doctrine::getTable('SpecimenSearch')->findForView('spec_ref',$request->getParameter('id'), $this->getUser()),'Specimen does not exist');  
