<?php if(isset($userParams) && isset($userParams['user_id']) && isset($userParams['hash']) && isset($userParams['servername'])):?>
...
<?php echo "http://".$userParams['servername'].url_for('account/renewPwd?'.http_build_query(array('id'=>$userParams['user_id'], 'hash'=>$userParams['hash'])))."\r\r";?>
