<div class="tabs<?php if(isset($view) && $view) echo '_view' ; ?>">
  ...
  <?php elseif(!$loan->isNew() && !isset($item) && !isset($items)):?>
    <a class="enabled selected" id="tab_0"> &lt; <?php if(isset($view) && $view) echo __('View Loan'); else echo __('Edit Loan');?> &gt; </a>
  ...
  <?php elseif(!$loan->isNew() && isset($items) ):?>
    <?php echo link_to( ((isset($view) && $view)  ? __('View Loan'): __('Edit Loan') ), 'loan/edit?id='.$loan->getId(), array('class'=>'enabled', 'id'=> 'tab_0'));?>
