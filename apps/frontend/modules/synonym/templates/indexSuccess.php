<div id="syn_screen">
<form action="<?php echo url_for('synonym/index?table='.$sf_request->getParameter('table').'&id='.$sf_request->getParameter('id') . ($form->getObject()->isNew() ? '': '&rid='.$form->getObject()->getId() ) );?>" method="post" id="synonym_form">
<table>
  <tr>
      <td colspan="2">
