...
<div class="page">
  ...
  <div class="contact_content">
    <p>
      <?php echo __('If you have a problem using the tool, or if you want to help : write a mail at <a href="mailto:darwin-ict@naturalsciences.be">darwin-ict@naturalsciences.be</a>');?>
    <p>
    <p>
