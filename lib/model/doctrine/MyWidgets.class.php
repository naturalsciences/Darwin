...
class MyWidgets extends BaseMyWidgets
{
  public static $help_widget = array(
    "cataloguewidget"=> array(
        ...
        "informativeWorkflow" => "This widget allow you to add a note for this specific catalogue, this note can be a modification suggestion, a question destined to managers, an own note to remind something to do, a explanation when a modification is added. The number of options in the status field depend on your privileges", 
        ),
    "individualswidget"=>array(
        ...
        "extLinks" => "This widget allows you to add a URL address to the record (ex : http://www.naturalsciences.be)", 
        "informativeWorkflow" => "This widget allow you to add a note for this specific individual, this note can be a modification suggestion, a question destined to managers, an own note to remind something to do, a explanation when a modification is added. The number of options in the status field depend on your privileges",        
        ),
    "partwidget"=> array(
        ...
        "informativeWorkflow" => "This widget allow you to add a note for this specific part, this note can be a modification suggestion, a question destined to managers, an own note to remind something to do, a explanation when a modification is added. The number of options in the status field depend on your privileges",        
        ),      
    "peoplewidget"=>array(
        "comment" => "This widget is used to add commentary.If you wish, You can add more than one commentary notion per record. You cannot add the same notion twice in one record, however",
        ...
        "extLinks" => "This widget allows you to add a URL address to the record (ex : http://www.naturalsciences.be)",
        "informativeWorkflow" => "This widget allow you to add a note for this specific people, this note can be a modification suggestion, a question destined to managers, an own note to remind something to do, a explanation when a modification is added. The number of options in the status field depend on your privileges",        
        ),
    ...
    "specimenwidget"=> array(
        ...
        "informativeWorkflow" => "This widget allow you to add a note for this specific specimen, this note can be a modification suggestion, a question destined to managers, an own note to remind something to do, a explanation when a modification is added. The number of options in the status field depend on your privileges",        
        ),
    "userswidget"=>array(
        "address" => "This widget allows you to add one or more addresses, it can be home address, work or more. The locality and the country are required fields", 
