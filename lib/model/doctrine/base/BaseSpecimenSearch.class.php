 ...
 * @property Igs $Ig
 * @property ClassVernacularNames $TaxonomyCommonNames
 * @property ClassVernacularNames $ChronoCommonNames
 * @property ClassVernacularNames $LithoCommonNames
 * @property ClassVernacularNames $LithologyCommonNames
 * @property ClassVernacularNames $MineralCommonNames
 * 
 ...
 * @method ClassVernacularNames getTaxonomyCommonNames()                           Returns the current record's "TaxonomyCommonNames" value
 * @method ClassVernacularNames getChronoCommonNames()                             Returns the current record's "ChronoCommonNames" value
 * @method ClassVernacularNames getLithoCommonNames()                              Returns the current record's "LithoCommonNames" value
 * @method ClassVernacularNames getLithologyCommonNames()                          Returns the current record's "LithologyCommonNames" value
 * @method ClassVernacularNames getMineralCommonNames()                            Returns the current record's "MineralCommonNames" value
 * @method SpecimenSearch       setId()                                            Sets the current record's "id" value
 ...
 * @method SpecimenSearch       setCollectionInstitutionFormatedNameIndexed()      Sets the current record's "collection_institution_formated_name_indexed" value
 * @method SpecimenSearch       setCollectionInstitutionSubType()                  Sets the current record's "collection_institution_sub_type" value
 * @method SpecimenSearch       setCollectionMainManagerRef()                      Sets the current record's "collection_main_manager_ref" value
 * @method SpecimenSearch       setCollectionMainManagerFormatedName()             Sets the current record's "collection_main_manager_formated_name" value
 * @method SpecimenSearch       setCollectionMainManagerFormatedNameTs()           Sets the current record's "collection_main_manager_formated_name_ts" value
 * @method SpecimenSearch       setCollectionMainManagerFormatedNameIndexed()      Sets the current record's "collection_main_manager_formated_name_indexed" value
 ...
 * @method SpecimenSearch       setTaxonomyCommonNames()                           Sets the current record's "TaxonomyCommonNames" value
 * @method SpecimenSearch       setChronoCommonNames()                             Sets the current record's "ChronoCommonNames" value
 * @method SpecimenSearch       setLithoCommonNames()                              Sets the current record's "LithoCommonNames" value
 * @method SpecimenSearch       setLithologyCommonNames()                          Sets the current record's "LithologyCommonNames" value
 * @method SpecimenSearch       setMineralCommonNames()                            Sets the current record's "MineralCommonNames" value
 * 
 * @package    darwin
 * @subpackage model
...
abstract class BaseSpecimenSearch extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasOne('ClassVernacularNames as TaxonomyCommonNames', array(
             'local' => 'taxon_ref',
             'foreign' => 'record_id'));

        $this->hasOne('ClassVernacularNames as ChronoCommonNames', array(
             'local' => 'chrono_ref',
             'foreign' => 'record_id'));

        $this->hasOne('ClassVernacularNames as LithoCommonNames', array(
             'local' => 'litho_ref',
             'foreign' => 'record_id'));

        $this->hasOne('ClassVernacularNames as LithologyCommonNames', array(
             'local' => 'lithology_ref',
             'foreign' => 'record_id'));

        $this->hasOne('ClassVernacularNames as MineralCommonNames', array(
             'local' => 'mineral_ref',
             'foreign' => 'record_id'));
    }
}