 ...
 * @method IgsSearch           setSpecRef()                  Sets the current record's "spec_ref" value
 * @method IgsSearch           setCategory()                 Sets the current record's "category" value
 * @method IgsSearch           setCollectionRef()            Sets the current record's "collection_ref" value
 * @method IgsSearch           setCollectionType()           Sets the current record's "collection_type" value
 * @method IgsSearch           setCollectionCode()           Sets the current record's "collection_code" value
 * @method IgsSearch           setCollectionName()           Sets the current record's "collection_name" value
 * @method IgsSearch           setCollectionIsPublic()       Sets the current record's "collection_is_public" value
 * @method IgsSearch           setCollectionParentRef()      Sets the current record's "collection_parent_ref" value
 * @method IgsSearch           setCollectionPath()           Sets the current record's "collection_path" value
 ...
 * @method IgsSearch           setStationVisible()           Sets the current record's "station_visible" value
 * @method IgsSearch           setGtuRef()                   Sets the current record's "gtu_ref" value
 * @method IgsSearch           setGtuCode()                  Sets the current record's "gtu_code" value
 * @method IgsSearch           setGtuParentRef()             Sets the current record's "gtu_parent_ref" value
 * @method IgsSearch           setGtuPath()                  Sets the current record's "gtu_path" value
 * @method IgsSearch           setGtuFromDateMask()          Sets the current record's "gtu_from_date_mask" value
 * @method IgsSearch           setGtuFromDate()              Sets the current record's "gtu_from_date" value
 * @method IgsSearch           setGtuToDateMask()            Sets the current record's "gtu_to_date_mask" value
 * @method IgsSearch           setGtuToDate()                Sets the current record's "gtu_to_date" value
 * @method IgsSearch           setGtuTagValuesIndexed()      Sets the current record's "gtu_tag_values_indexed" value
 * @method IgsSearch           setGtuCountryTagIndexed()     Sets the current record's "gtu_country_tag_indexed" value
 * @method IgsSearch           setGtuCountryTagValue()       Sets the current record's "gtu_country_tag_value" value
 * @method IgsSearch           setGtuElevation()             Sets the current record's "gtu_elevation" value
 * @method IgsSearch           setGtuElevationAccuracy()     Sets the current record's "gtu_elevation_accuracy" value
 * @method IgsSearch           setGtuLocation()              Sets the current record's "gtu_location" value
 * @method IgsSearch           setTaxonRef()                 Sets the current record's "taxon_ref" value
 * @method IgsSearch           setTaxonName()                Sets the current record's "taxon_name" value
 * @method IgsSearch           setTaxonNameIndexed()         Sets the current record's "taxon_name_indexed" value
 * @method IgsSearch           setTaxonNameOrderBy()         Sets the current record's "taxon_name_order_by" value
 * @method IgsSearch           setTaxonLevelRef()            Sets the current record's "taxon_level_ref" value
 * @method IgsSearch           setTaxonLevelName()           Sets the current record's "taxon_level_name" value
 * @method IgsSearch           setTaxonStatus()              Sets the current record's "taxon_status" value
 * @method IgsSearch           setTaxonPath()                Sets the current record's "taxon_path" value
 * @method IgsSearch           setTaxonParentRef()           Sets the current record's "taxon_parent_ref" value
 * @method IgsSearch           setTaxonExtinct()             Sets the current record's "taxon_extinct" value
 * @method IgsSearch           setLithoRef()                 Sets the current record's "litho_ref" value
 * @method IgsSearch           setLithoName()                Sets the current record's "litho_name" value
 * @method IgsSearch           setLithoNameIndexed()         Sets the current record's "litho_name_indexed" value
 * @method IgsSearch           setLithoNameOrderBy()         Sets the current record's "litho_name_order_by" value
 * @method IgsSearch           setLithoLevelRef()            Sets the current record's "litho_level_ref" value
 * @method IgsSearch           setLithoLevelName()           Sets the current record's "litho_level_name" value
 * @method IgsSearch           setLithoStatus()              Sets the current record's "litho_status" value
 * @method IgsSearch           setLithoLocal()               Sets the current record's "litho_local" value
 * @method IgsSearch           setLithoColor()               Sets the current record's "litho_color" value
 * @method IgsSearch           setLithoPath()                Sets the current record's "litho_path" value
 * @method IgsSearch           setLithoParentRef()           Sets the current record's "litho_parent_ref" value
 * @method IgsSearch           setChronoRef()                Sets the current record's "chrono_ref" value
 * @method IgsSearch           setChronoName()               Sets the current record's "chrono_name" value
 * @method IgsSearch           setChronoNameIndexed()        Sets the current record's "chrono_name_indexed" value
 * @method IgsSearch           setChronoNameOrderBy()        Sets the current record's "chrono_name_order_by" value
 * @method IgsSearch           setChronoLevelRef()           Sets the current record's "chrono_level_ref" value
 * @method IgsSearch           setChronoLevelName()          Sets the current record's "chrono_level_name" value
 * @method IgsSearch           setChronoStatus()             Sets the current record's "chrono_status" value
 * @method IgsSearch           setChronoLocal()              Sets the current record's "chrono_local" value
 * @method IgsSearch           setChronoColor()              Sets the current record's "chrono_color" value
 * @method IgsSearch           setChronoPath()               Sets the current record's "chrono_path" value
 * @method IgsSearch           setChronoParentRef()          Sets the current record's "chrono_parent_ref" value
 * @method IgsSearch           setLithologyRef()             Sets the current record's "lithology_ref" value
 * @method IgsSearch           setLithologyName()            Sets the current record's "lithology_name" value
 * @method IgsSearch           setLithologyNameIndexed()     Sets the current record's "lithology_name_indexed" value
 * @method IgsSearch           setLithologyNameOrderBy()     Sets the current record's "lithology_name_order_by" value
 * @method IgsSearch           setLithologyLevelRef()        Sets the current record's "lithology_level_ref" value
 * @method IgsSearch           setLithologyLevelName()       Sets the current record's "lithology_level_name" value
 * @method IgsSearch           setLithologyStatus()          Sets the current record's "lithology_status" value
 * @method IgsSearch           setLithologyLocal()           Sets the current record's "lithology_local" value
 * @method IgsSearch           setLithologyColor()           Sets the current record's "lithology_color" value
 * @method IgsSearch           setLithologyPath()            Sets the current record's "lithology_path" value
 * @method IgsSearch           setLithologyParentRef()       Sets the current record's "lithology_parent_ref" value
 * @method IgsSearch           setMineralRef()               Sets the current record's "mineral_ref" value
 * @method IgsSearch           setMineralName()              Sets the current record's "mineral_name" value
 * @method IgsSearch           setMineralNameIndexed()       Sets the current record's "mineral_name_indexed" value
 * @method IgsSearch           setMineralNameOrderBy()       Sets the current record's "mineral_name_order_by" value
 * @method IgsSearch           setMineralLevelRef()          Sets the current record's "mineral_level_ref" value
 * @method IgsSearch           setMineralLevelName()         Sets the current record's "mineral_level_name" value
 * @method IgsSearch           setMineralStatus()            Sets the current record's "mineral_status" value
 * @method IgsSearch           setMineralLocal()             Sets the current record's "mineral_local" value
 * @method IgsSearch           setMineralColor()             Sets the current record's "mineral_color" value
 * @method IgsSearch           setMineralPath()              Sets the current record's "mineral_path" value
 * @method IgsSearch           setMineralParentRef()         Sets the current record's "mineral_parent_ref" value
 * @method IgsSearch           setHostTaxonRef()             Sets the current record's "host_taxon_ref" value
 * @method IgsSearch           setHostRelationship()         Sets the current record's "host_relationship" value
 * @method IgsSearch           setHostTaxonName()            Sets the current record's "host_taxon_name" value
 * @method IgsSearch           setHostTaxonNameIndexed()     Sets the current record's "host_taxon_name_indexed" value
 * @method IgsSearch           setHostTaxonNameOrderBy()     Sets the current record's "host_taxon_name_order_by" value
 * @method IgsSearch           setHostTaxonLevelRef()        Sets the current record's "host_taxon_level_ref" value
 * @method IgsSearch           setHostTaxonLevelName()       Sets the current record's "host_taxon_level_name" value
 * @method IgsSearch           setHostTaxonStatus()          Sets the current record's "host_taxon_status" value
 * @method IgsSearch           setHostTaxonPath()            Sets the current record's "host_taxon_path" value
 * @method IgsSearch           setHostTaxonParentRef()       Sets the current record's "host_taxon_parent_ref" value
 * @method IgsSearch           setHostTaxonExtinct()         Sets the current record's "host_taxon_extinct" value
 * @method IgsSearch           setHostSpecimenRef()          Sets the current record's "host_specimen_ref" value
 ...
 * @method IgsSearch           setIgDate()                   Sets the current record's "ig_date" value
 * @method IgsSearch           setAcquisitionCategory()      Sets the current record's "acquisition_category" value
 * @method IgsSearch           setAcquisitionDateMask()      Sets the current record's "acquisition_date_mask" value
 * @method IgsSearch           setAcquisitionDate()          Sets the current record's "acquisition_date" value
 * @method IgsSearch           setWithTypes()                Sets the current record's "with_types" value
 * @method IgsSearch           setWithIndividuals()          Sets the current record's "with_individuals" value
 * @method IgsSearch           setIndividualRef()            Sets the current record's "individual_ref" value
 * @method IgsSearch           setIndividualType()           Sets the current record's "individual_type" value
 * @method IgsSearch           setIndividualTypeGroup()      Sets the current record's "individual_type_group" value
 * @method IgsSearch           setIndividualTypeSearch()     Sets the current record's "individual_type_search" value
 * @method IgsSearch           setIndividualSex()            Sets the current record's "individual_sex" value
 * @method IgsSearch           setIndividualState()          Sets the current record's "individual_state" value
 * @method IgsSearch           setIndividualStage()          Sets the current record's "individual_stage" value
 * @method IgsSearch           setIndividualSocialStatus()   Sets the current record's "individual_social_status" value
 * @method IgsSearch           setIndividualRockForm()       Sets the current record's "individual_rock_form" value
 * @method IgsSearch           setIndividualCountMin()       Sets the current record's "individual_count_min" value
 * @method IgsSearch           setIndividualCountMax()       Sets the current record's "individual_count_max" value
 * @method IgsSearch           setWithParts()                Sets the current record's "with_parts" value
 * @method IgsSearch           setPartRef()                  Sets the current record's "part_ref" value
 * @method IgsSearch           setPart()                     Sets the current record's "part" value
 * @method IgsSearch           setPartStatus()               Sets the current record's "part_status" value
 * @method IgsSearch           setInstitutionRef()           Sets the current record's "institution_ref" value
 * @method IgsSearch           setBuilding()                 Sets the current record's "building" value
 * @method IgsSearch           setFloor()                    Sets the current record's "floor" value
 * @method IgsSearch           setRoom()                     Sets the current record's "room" value
 * @method IgsSearch           setRow()                      Sets the current record's "row" value
 * @method IgsSearch           setShelf()                    Sets the current record's "shelf" value
 * @method IgsSearch           setContainerType()            Sets the current record's "container_type" value
 * @method IgsSearch           setContainerStorage()         Sets the current record's "container_storage" value
 * @method IgsSearch           setContainer()                Sets the current record's "container" value
 * @method IgsSearch           setSubContainerType()         Sets the current record's "sub_container_type" value
 * @method IgsSearch           setSubContainerStorage()      Sets the current record's "sub_container_storage" value
 * @method IgsSearch           setSubContainer()             Sets the current record's "sub_container" value
 * @method IgsSearch           setPartCountMin()             Sets the current record's "part_count_min" value
 * @method IgsSearch           setPartCountMax()             Sets the current record's "part_count_max" value
 * @method IgsSearch           setSpecimenStatus()           Sets the current record's "specimen_status" value
 * @method IgsSearch           setComplete()                 Sets the current record's "complete" value
 * @method IgsSearch           setSurnumerary()              Sets the current record's "surnumerary" value
 * @method IgsSearch           setSpecimen()                 Sets the current record's "Specimen" value
 * @method IgsSearch           setSpecimenIndividual()       Sets the current record's "SpecimenIndividual" value
 * @method IgsSearch           setPartRelation()             Sets the current record's "PartRelation" value
 * @method IgsSearch           setCollection()               Sets the current record's "Collection" value
 * @method IgsSearch           setCollectionParent()         Sets the current record's "CollectionParent" value
 * @method IgsSearch           setExpedition()               Sets the current record's "Expedition" value
 * @method IgsSearch           setGtu()                      Sets the current record's "Gtu" value
 * @method IgsSearch           setGtuParent()                Sets the current record's "GtuParent" value
 * @method IgsSearch           setTaxonomy()                 Sets the current record's "Taxonomy" value
 * @method IgsSearch           setTaxonomyLevel()            Sets the current record's "TaxonomyLevel" value
 * @method IgsSearch           setTaxonomyParent()           Sets the current record's "TaxonomyParent" value
 * @method IgsSearch           setLithostratigraphy()        Sets the current record's "Lithostratigraphy" value
 * @method IgsSearch           setLithostratigraphyLevel()   Sets the current record's "LithostratigraphyLevel" value
 * @method IgsSearch           setLithostratigraphyParent()  Sets the current record's "LithostratigraphyParent" value
 * @method IgsSearch           setChronostratigraphy()       Sets the current record's "Chronostratigraphy" value
 * @method IgsSearch           setChronostratigraphyLevel()  Sets the current record's "ChronostratigraphyLevel" value
 * @method IgsSearch           setChronostratigraphyParent() Sets the current record's "ChronostratigraphyParent" value
 * @method IgsSearch           setLithology()                Sets the current record's "Lithology" value
 * @method IgsSearch           setLithologyLevel()           Sets the current record's "LithologyLevel" value
 * @method IgsSearch           setLithologyParent()          Sets the current record's "LithologyParent" value
 * @method IgsSearch           setMineralogy()               Sets the current record's "Mineralogy" value
 * @method IgsSearch           setMineralogyLevel()          Sets the current record's "MineralogyLevel" value
 * @method IgsSearch           setMineralogyParent()         Sets the current record's "MineralogyParent" value
 * @method IgsSearch           setHostTaxon()                Sets the current record's "HostTaxon" value
 * @method IgsSearch           setHostTaxonLevel()           Sets the current record's "HostTaxonLevel" value
 * @method IgsSearch           setHostTaxonParent()          Sets the current record's "HostTaxonParent" value
 * @method IgsSearch           setHostSpecimen()             Sets the current record's "HostSpecimen" value
 * @method IgsSearch           setIg()                       Sets the current record's "Ig" value
 * 
 * @package    darwin
 * @subpackage model
