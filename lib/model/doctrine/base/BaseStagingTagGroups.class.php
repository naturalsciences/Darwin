 ...
 * 
 * @property integer $id
 * @property integer, notnull: true} $staging_ref:{ type
 ...
 */
abstract class BaseStagingTagGroups extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('staging_ref:{ type', 'integer, notnull: true}', null, array(
