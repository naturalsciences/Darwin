...
abstract class BaseUsers extends sfDoctrineRecord
{
    ...
    {
        $this->hasMany('UsersLanguages', array('local' => 'id',
                                               'foreign' => 'users_ref'));

        $this->hasMany('UsersComm', array('local' => 'id',
                                          'foreign' => 'person_user_ref'));

        $this->hasMany('UsersAddresses', array('local' => 'id',
                                               'foreign' => 'person_user_ref'));

        $this->hasMany('UsersLoginInfos', array('local' => 'id',
                                                'foreign' => 'user_ref'));
        ...
        $this->hasMany('RecordVisibilities', array('local' => 'id',
                                                   'foreign' => 'user_ref'));

        $this->hasMany('UsersWorkflow', array('local' => 'id',
                                              'foreign' => 'user_ref'));

        $this->hasMany('UsersTablesFieldsTracked', array('local' => 'id',
                                                         'foreign' => 'user_ref'));

        $this->hasMany('UsersTracking', array('local' => 'id',
                                              'foreign' => 'user_ref'));

        $this->hasMany('CollectionMaintenance', array('local' => 'id',
                                                      'foreign' => 'user_ref'));

        $this->hasMany('MySavedSearches', array('local' => 'id',
                                                'foreign' => 'user_ref'));

        $this->hasMany('MyPreferences', array('local' => 'id',
                                              'foreign' => 'user_ref'));

        $this->hasMany('MySavedSpecimens', array('local' => 'id',
                                                 'foreign' => 'user_ref'));
    }
}