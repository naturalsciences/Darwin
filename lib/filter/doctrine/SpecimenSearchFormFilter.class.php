  ...
  public function doBuildQuery(array $values)
  {
    ...
    if($values['what_searched'] == 'specimen')
    {
      ...
      $query = DQ::create()
        ...
        ->select($str .' MIN(id) as id, dummy_first(ST_Y(ST_Centroid(geometry(gtu_location)))) as latitude, dummy_first(ST_X(ST_Centroid(geometry(gtu_location)))) as longitude ')
        ->groupBy('spec_ref');
    ...
    elseif($values['what_searched'] == 'individual')
    {
      ...
      $query = DQ::create()
        ...
        ->select($str .' MIN(id) as id,  false as with_types, dummy_first(ST_Y(ST_Centroid(geometry(gtu_location)))) as latitude, dummy_first(ST_X(ST_Centroid(geometry(gtu_location)))) as longitude ')
    ...
    else
    {
      ...
      $query = DQ::create()
        ->select($str.' , false as with_types, id, ST_Y(ST_Centroid(geometry(gtu_location))) as latitude, ST_X(ST_Centroid(geometry(gtu_location))) as longitude ')
