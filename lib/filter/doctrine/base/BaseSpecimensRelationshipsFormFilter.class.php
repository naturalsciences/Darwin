...
abstract class BaseSpecimensRelationshipsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'specimen_related_ref' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'specimen_related_ref' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
