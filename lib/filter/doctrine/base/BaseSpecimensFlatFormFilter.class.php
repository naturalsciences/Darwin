...
/**
 * SpecimensFlat filter form base class.
 *
 * @package    darwin
 * @subpackage filter
 ...
 */
abstract class BaseSpecimensFlatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('specimens_flat_filters[%s]');
