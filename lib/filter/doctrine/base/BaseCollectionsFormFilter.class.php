...
class BaseCollectionsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'main_manager_ref'         => new sfWidgetFormDoctrineChoice(array('model' => 'People', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'main_manager_ref'         => new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'People', 'column' => 'id')),
