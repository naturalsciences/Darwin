...
abstract class BaseCollectionsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'code_auto_increment_even_if_existing_numeric' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'code_auto_increment_even_if_existing_numeric' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
  ...
  public function getFields()
  {
    return array(
      ...
      'code_auto_increment_even_if_existing_numeric' => 'Boolean',
