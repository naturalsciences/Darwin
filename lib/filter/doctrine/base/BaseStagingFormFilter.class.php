...
abstract class BaseStagingFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'host_taxon_ref'           => new sfWidgetFormFilterInput(),
      ...
      'host_specimen_ref'        => new sfWidgetFormFilterInput(),
      ...
      'individual_type_group'    => new sfWidgetFormFilterInput(),
      'individual_type_search'   => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'host_specimen_ref'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
