...
class CodesForm extends BaseCodesForm
{
  public function configure()
  {
    ...
    $this->useFields(array('id', 'referenced_relation', 'record_id', 'code_category', 'code_prefix', 'code_prefix_separator', 'code', 'code_suffix', 'code_suffix_separator', 'code_date'));
