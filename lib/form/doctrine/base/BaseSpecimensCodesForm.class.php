...
abstract class BaseSpecimensCodesForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'record_id'             => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('SpecimensFlat'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'record_id'             => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('SpecimensFlat'))),
