...
abstract class BaseIgsSearchForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'expedition_ref'           => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      ...
      'expedition_ref'           => new sfValidatorChoice(array('choices' => array($this->getObject()->get('expedition_ref')), 'empty_value' => $this->getObject()->get('expedition_ref'), 'required' => false)),
