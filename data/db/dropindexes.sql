 ...
 DROP INDEX IF EXISTS idx_my_preferences_visible;
 DROP INDEX IF EXISTS idx_multimedia_type;
 DROP INDEX IF EXISTS idx_my_preferences_group_name;
 DROP INDEX IF EXISTS idx_multimedia_keywords_keyword_indexed;
 DROP INDEX IF EXISTS idx_my_preferences_is_available;
 DROP INDEX IF EXISTS idx_people_title;
 DROP INDEX IF EXISTS idx_my_preferences_order_by;
