...
CREATE INDEX CONCURRENTLY idx_collections_parent_collection_ref on collections(parent_collection_ref);
...
CREATE INDEX CONCURRENTLY idx_taxonomy_naming on taxonomy(level_ref, name_indexed);
...
CREATE INDEX CONCURRENTLY idx_chronostratigraphy_naming on chronostratigraphy(level_ref, name_indexed);
...
CREATE INDEX CONCURRENTLY idx_lithostratigraphy_naming on lithostratigraphy(level_ref, name_indexed);
...
CREATE INDEX CONCURRENTLY idx_mineralogy_naming on mineralogy(level_ref, name_indexed);
