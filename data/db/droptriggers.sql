...
DROP TRIGGER trg_clr_referenceRecord_possibleupperlevels ON possible_upper_levels;
DROP TRIGGER trg_clr_referenceRecord_comments ON comments;
DROP TRIGGER trg_clr_referenceRecord_tags ON tags;
DROP TRIGGER trg_clr_referenceRecord_taggroups ON tag_groups;
...
DROP TRIGGER trg_clr_referenceRecord_classvernacularnames ON class_vernacular_names;
...
DROP TRIGGER trg_clr_referenceRecord_peoplelanguages ON people_languages;
DROP TRIGGER trg_clr_referenceRecord_userslanguages ON users_languages;
...
DROP TRIGGER trg_clr_referenceRecord_peoplecomm ON people_comm;
DROP TRIGGER trg_clr_referenceRecord_peopleaddresses ON people_addresses;
DROP TRIGGER trg_clr_referenceRecord_userscomm ON users_comm;
DROP TRIGGER trg_clr_referenceRecord_usersaddresses ON users_addresses;
DROP TRIGGER trg_clr_referenceRecord_userslogininfos ON users_login_infos;
DROP TRIGGER trg_clr_referenceRecord_peoplemultimedia ON people_multimedia;
DROP TRIGGER trg_clr_referenceRecord_usersmultimedia ON users_multimedia;
DROP TRIGGER trg_clr_referenceRecord_collections ON collections;
DROP TRIGGER trg_clr_referenceRecord_collectionsadmin ON collections_admin;
DROP TRIGGER trg_clr_referenceRecord_collectionsrights ON collections_rights;
DROP TRIGGER trg_clr_referenceRecord_collectionsfieldsvisibilities ON collections_fields_visibilities;
DROP TRIGGER trg_clr_referenceRecord_userscollrightsasked ON users_coll_rights_asked;
DROP TRIGGER trg_clr_referenceRecord_recordvisibilities ON record_visibilities;
DROP TRIGGER trg_clr_referenceRecord_usersworkflow ON users_workflow;
DROP TRIGGER trg_clr_referenceRecord_mysavedsearches ON collection_maintenance;
DROP TRIGGER trg_clr_referenceRecord_mysavedsearches ON my_saved_searches;
DROP TRIGGER trg_clr_referenceRecord_mypreferences ON my_preferences;
DROP TRIGGER trg_clr_referenceRecord_mysavedspecimens ON my_saved_specimens;
DROP TRIGGER trg_clr_referenceRecord_taxa ON taxa;
DROP TRIGGER trg_clr_referenceRecord_peopletaxonomicnames ON people_taxonomic_names;
...
DROP TRIGGER trg_clr_referenceRecord_multimediakeywords ON multimedia_keywords;
...
DROP TRIGGER trg_clr_referenceRecord_specimenscodes ON specimens_codes;
DROP TRIGGER trg_clr_referenceRecord_multimediacodes ON multimedia_codes;
...
DROP TRIGGER trg_clr_referenceRecord_specimenpartscodes ON specimen_parts_codes;
DROP TRIGGER trg_clr_referenceRecord_specimenpartsinsurances ON specimen_parts_insurances;
DROP TRIGGER trg_clr_referenceRecord_associatedmultimedia ON associated_multimedia;
