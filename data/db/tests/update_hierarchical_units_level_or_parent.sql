...
SELECT ok(to_tsvector('simple', 'KÉLoWÿ') = (SELECT era_indexed FROM chronostratigraphy WHERE id = 2), 'New era_indexed of unit 2 : kelowy');
SELECT ok(2 = (SELECT sub_era_ref FROM chronostratigraphy WHERE id = 2), 'New sub_era_ref of unit 2 : 2');
SELECT ok(to_tsvector('simple', 'ÉLoWÿ') = (SELECT sub_era_indexed FROM chronostratigraphy WHERE id = 2), 'New sub_era_indexed of unit 2 : elowy');
...
SELECT ok(to_tsvector('simple', 'KÉLoWÿ') = (SELECT era_indexed FROM chronostratigraphy WHERE id = 4), 'New era_indexed of unit 4 : kelowy');
SELECT ok(2 = (SELECT sub_era_ref FROM chronostratigraphy WHERE id = 4), 'New sub_era_ref of unit 4 : 2');
SELECT ok(to_tsvector('simple', 'ÉLoWÿ') = (SELECT sub_era_indexed FROM chronostratigraphy WHERE id = 4), 'New sub_era_indexed of unit 4 : elowy');
SELECT ok(4 = (SELECT system_ref FROM chronostratigraphy WHERE id = 4), 'New system_ref of unit 4 : 4');
SELECT ok(to_tsvector('simple', 'BÉLoWÿ') = (SELECT system_indexed FROM chronostratigraphy WHERE id = 4), 'New system_indexed of unit 4 : belowy');
...
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€') = (SELECT group_indexed FROM lithostratigraphy WHERE id = 2), 'New group_indexed of unit 2: mealonyeob');
SELECT ok(3 = (SELECT formation_ref FROM lithostratigraphy WHERE id = 2), 'New formation_ref of unit 2: 3');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€B') = (SELECT formation_indexed FROM lithostratigraphy WHERE id = 2), 'New formation_indexed of unit 2: mealonyeobb');
SELECT ok(2 = (SELECT member_ref FROM lithostratigraphy WHERE id = 2), 'New member_ref of unit 2: 2');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€A') = (SELECT member_indexed FROM lithostratigraphy WHERE id = 2), 'New member_indexed of unit 2: mealonyeoba');
...
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€') = (SELECT group_indexed FROM lithostratigraphy WHERE id = 4), 'New group_indexed of unit 2: mealonyeob');
SELECT ok(3 = (SELECT formation_ref FROM lithostratigraphy WHERE id = 4), 'New formation_ref of unit 4: 3');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€B') = (SELECT formation_indexed FROM lithostratigraphy WHERE id = 4), 'New formation_indexed of unit 4: mealonyeobb');
SELECT ok(2 = (SELECT member_ref FROM lithostratigraphy WHERE id = 4), 'New member_ref of unit 4: 2');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€A') = (SELECT member_indexed FROM lithostratigraphy WHERE id = 4), 'New member_indexed of unit 4: mealonyeoba');
SELECT ok(4 = (SELECT layer_ref FROM lithostratigraphy WHERE id = 4), 'New layer_ref of unit 4: 4');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€C') = (SELECT layer_indexed FROM lithostratigraphy WHERE id = 4), 'New layer_ref of unit 4: mealonyeobc');
...
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€') = (SELECT unit_main_group_indexed FROM lithology WHERE id = 2), 'New unit_main_group_indexed of unit 2: mealonyeob');
SELECT ok(3 = (SELECT unit_group_ref FROM lithology WHERE id = 2), 'New unit_group_ref of unit 2: 3');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€B') = (SELECT unit_group_indexed FROM lithology WHERE id = 2), 'New unit_group_indexed of unit 2: mealonyeobb');
SELECT ok(2 = (SELECT unit_sub_group_ref FROM lithology WHERE id = 2), 'New unit_sub_group_ref of unit 2: 2');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€A') = (SELECT unit_sub_group_indexed FROM lithology WHERE id = 2), 'New unit_sub_group_indexed of unit 2: mealonyeoba');
...
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€') = (SELECT unit_main_group_indexed FROM lithology WHERE id = 4), 'New unit_main_group_indexed of unit 2: mealonyeob');
SELECT ok(3 = (SELECT unit_group_ref FROM lithology WHERE id = 4), 'New unit_group_ref of unit 4: 3');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€B') = (SELECT unit_group_indexed FROM lithology WHERE id = 4), 'New unit_group_indexed of unit 4: mealonyeobb');
SELECT ok(2 = (SELECT unit_sub_group_ref FROM lithology WHERE id = 4), 'New unit_sub_group_ref of unit 4: 2');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€A') = (SELECT unit_sub_group_indexed FROM lithology WHERE id = 4), 'New unit_sub_group_indexed of unit 4: mealonyeoba');
SELECT ok(4 = (SELECT unit_rock_ref FROM lithology WHERE id = 4), 'New unit_rock_ref of unit 4: 4');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€C') = (SELECT unit_rock_indexed FROM lithology WHERE id = 4), 'New unit_rock_ref of unit 4: mealonyeobc');
...
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€') = (SELECT unit_class_indexed FROM mineralogy WHERE id = 2), 'New unit_class_indexed of unit 2: mealonyeob');
SELECT ok(3 = (SELECT unit_division_ref FROM mineralogy WHERE id = 2), 'New unit_division_ref of unit 2: 3');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€B') = (SELECT unit_division_indexed FROM mineralogy WHERE id = 2), 'New unit_division_indexed of unit 2: mealonyeobb');
SELECT ok(2 = (SELECT unit_family_ref FROM mineralogy WHERE id = 2), 'New unit_family_ref of unit 2: 2');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€A') = (SELECT unit_family_indexed FROM mineralogy WHERE id = 2), 'New unit_family_indexed of unit 2: mealonyeoba');
...
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€') = (SELECT unit_class_indexed FROM mineralogy WHERE id = 4), 'New unit_class_indexed of unit 2: mealonyeob');
SELECT ok(3 = (SELECT unit_division_ref FROM mineralogy WHERE id = 4), 'New unit_division_ref of unit 4: 3');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€B') = (SELECT unit_division_indexed FROM mineralogy WHERE id = 4), 'New unit_division_indexed of unit 4: mealonyeobb');
SELECT ok(2 = (SELECT unit_family_ref FROM mineralogy WHERE id = 4), 'New unit_family_ref of unit 4: 2');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€A') = (SELECT unit_family_indexed FROM mineralogy WHERE id = 4), 'New unit_family_indexed of unit 4: mealonyeoba');
SELECT ok(4 = (SELECT unit_group_ref FROM mineralogy WHERE id = 4), 'New unit_group_ref of unit 4: 4');
SELECT ok(to_tsvector('simple', 'Méalo-nÿeø@ß€C') = (SELECT unit_group_indexed FROM mineralogy WHERE id = 4), 'New unit_group_ref of unit 4: mealonyeobc');
...
SELECT ok(to_tsvector('simple', 'B') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 3), 'New kingdom_indexed of unit 3: b');
SELECT ok(3 = (SELECT phylum_ref FROM taxonomy WHERE id = 3), 'New phylum_ref of unit 3: 3');
SELECT ok(to_tsvector('simple', 'AA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 3), 'New phylum_indexed of unit 3: aa');
SELECT ok(11 = (SELECT kingdom_ref FROM taxonomy WHERE id = 4), 'New kingdom_ref of unit 4: 11');
SELECT ok(to_tsvector('simple', 'B') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 4), 'New kingdom_indexed of unit 4: b');
SELECT ok(3 = (SELECT phylum_ref FROM taxonomy WHERE id = 4), 'New phylum_ref of unit 4: 3');
SELECT ok(to_tsvector('simple', 'AA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 4), 'New phylum_indexed of unit 4: aa');
SELECT ok(11 = (SELECT kingdom_ref FROM taxonomy WHERE id = 5), 'New kingdom_ref of unit 5: 11');
SELECT ok(to_tsvector('simple', 'B') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 5), 'New kingdom_indexed of unit 5: b');
SELECT ok(11 = (SELECT kingdom_ref FROM taxonomy WHERE id = 6), 'New kingdom_ref of unit 6: 11');
SELECT ok(to_tsvector('simple', 'B') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 6), 'New kingdom_indexed of unit 6: b');
SELECT ok(11 = (SELECT kingdom_ref FROM taxonomy WHERE id = 7), 'New kingdom_ref of unit 7: 11');
SELECT ok(to_tsvector('simple', 'B') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 7), 'New kingdom_indexed of unit 7: b');
SELECT ok(11 = (SELECT kingdom_ref FROM taxonomy WHERE id = 8), 'New kingdom_ref of unit 8: 11');
SELECT ok(to_tsvector('simple', 'B') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 8), 'New kingdom_indexed of unit 8: b');
SELECT ok(11 = (SELECT kingdom_ref FROM taxonomy WHERE id = 9), 'New kingdom_ref of unit 9: 11');
SELECT ok(to_tsvector('simple', 'B') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 9), 'New kingdom_indexed of unit 9: b');
SELECT ok(11 = (SELECT kingdom_ref FROM taxonomy WHERE id = 10), 'New kingdom_ref of unit 10: 11');
SELECT ok(to_tsvector('simple', 'B') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 10), 'New kingdom_indexed of unit 10: b');
SELECT ok(3 = (SELECT phylum_ref FROM taxonomy WHERE id = 10), 'New phylum_ref of unit 10: 3');
SELECT ok(to_tsvector('simple', 'AA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 10), 'New phylum_indexed of unit 10: aa');
...
SELECT ok(to_tsvector('simple', 'C') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 4), 'New kingdom_indexed of unit 4: c');
SELECT ok(13 = (SELECT phylum_ref FROM taxonomy WHERE id = 4), 'New phylum_ref of unit 4: 13');
SELECT ok(to_tsvector('simple', 'CA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 4), 'New phylum_indexed of unit 4: ca');
SELECT ok(12 = (SELECT kingdom_ref FROM taxonomy WHERE id = 5), 'New kingdom_ref of unit 5: 12');
SELECT ok(to_tsvector('simple', 'C') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 5), 'New kingdom_indexed of unit 5: c');
SELECT ok(13 = (SELECT phylum_ref FROM taxonomy WHERE id = 5), 'New phylum_ref of unit 5: 13');
SELECT ok(to_tsvector('simple', 'CA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 5), 'New phylum_indexed of unit 5: ca');
SELECT ok(12 = (SELECT kingdom_ref FROM taxonomy WHERE id = 6), 'New kingdom_ref of unit 6: 12');
SELECT ok(to_tsvector('simple', 'C') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 6), 'New kingdom_indexed of unit 6: c');
SELECT ok(13 = (SELECT phylum_ref FROM taxonomy WHERE id = 6), 'New phylum_ref of unit 6: 13');
SELECT ok(to_tsvector('simple', 'CA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 6), 'New phylum_indexed of unit 6: ca');
SELECT ok(12 = (SELECT kingdom_ref FROM taxonomy WHERE id = 7), 'New kingdom_ref of unit 7: 12');
SELECT ok(to_tsvector('simple', 'C') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 7), 'New kingdom_indexed of unit 7: c');
SELECT ok(13 = (SELECT phylum_ref FROM taxonomy WHERE id = 7), 'New phylum_ref of unit 7: 13');
SELECT ok(to_tsvector('simple', 'CA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 7), 'New phylum_indexed of unit 7: ca');
SELECT ok(12 = (SELECT kingdom_ref FROM taxonomy WHERE id = 8), 'New kingdom_ref of unit 8: 12');
SELECT ok(to_tsvector('simple', 'C') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 8), 'New kingdom_indexed of unit 8: c');
SELECT ok(13 = (SELECT phylum_ref FROM taxonomy WHERE id = 8), 'New phylum_ref of unit 8: 13');
SELECT ok(to_tsvector('simple', 'CA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 8), 'New phylum_indexed of unit 8: ca');
SELECT ok(12 = (SELECT kingdom_ref FROM taxonomy WHERE id = 9), 'New kingdom_ref of unit 9: 12');
SELECT ok(to_tsvector('simple', 'C') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 9), 'New kingdom_indexed of unit 9: c');
SELECT ok(13 = (SELECT phylum_ref FROM taxonomy WHERE id = 9), 'New phylum_ref of unit 9: 13');
SELECT ok(to_tsvector('simple', 'CA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 9), 'New phylum_indexed of unit 9: ca');
SELECT ok(12 = (SELECT kingdom_ref FROM taxonomy WHERE id = 10), 'New kingdom_ref of unit 10: 12');
SELECT ok(to_tsvector('simple', 'C') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 10), 'New kingdom_indexed of unit 10: c');
SELECT ok(13 = (SELECT phylum_ref FROM taxonomy WHERE id = 10), 'New phylum_ref of unit 10: 13');
SELECT ok(to_tsvector('simple', 'CA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 10), 'New phylum_indexed of unit 10: ca');
...
SELECT ok(to_tsvector('simple', 'D') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 5), 'New kingdom_indexed of unit 5: d');
SELECT ok(15 = (SELECT phylum_ref FROM taxonomy WHERE id = 5), 'New phylum_ref of unit 5: 15');
SELECT ok(to_tsvector('simple', 'DA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 5), 'New phylum_indexed of unit 5: da');
SELECT ok(16 = (SELECT class_ref FROM taxonomy WHERE id = 5), 'New class_ref of unit 5: 16');
SELECT ok(to_tsvector('simple', 'DAA') = (SELECT class_indexed FROM taxonomy WHERE id = 5), 'New class_indexed of unit 5: daa');
SELECT ok(14 = (SELECT kingdom_ref FROM taxonomy WHERE id = 6), 'New kingdom_ref of unit 6: 14');
SELECT ok(to_tsvector('simple', 'D') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 6), 'New kingdom_indexed of unit 6: d');
SELECT ok(15 = (SELECT phylum_ref FROM taxonomy WHERE id = 6), 'New phylum_ref of unit 6: 15');
SELECT ok(to_tsvector('simple', 'DA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 6), 'New phylum_indexed of unit 6: da');
SELECT ok(16 = (SELECT class_ref FROM taxonomy WHERE id = 6), 'New class_ref of unit 6: 16');
SELECT ok(to_tsvector('simple', 'DAA') = (SELECT class_indexed FROM taxonomy WHERE id = 6), 'New class_indexed of unit 6: daa');
SELECT ok(14 = (SELECT kingdom_ref FROM taxonomy WHERE id = 7), 'New kingdom_ref of unit 7: 14');
SELECT ok(to_tsvector('simple', 'D') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 7), 'New kingdom_indexed of unit 7: d');
SELECT ok(15 = (SELECT phylum_ref FROM taxonomy WHERE id = 7), 'New phylum_ref of unit 7: 15');
SELECT ok(to_tsvector('simple', 'DA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 7), 'New phylum_indexed of unit 7: da');
SELECT ok(16 = (SELECT class_ref FROM taxonomy WHERE id = 7), 'New class_ref of unit 7: 16');
SELECT ok(to_tsvector('simple', 'DAA') = (SELECT class_indexed FROM taxonomy WHERE id = 7), 'New class_indexed of unit 7: daa');
SELECT ok(14 = (SELECT kingdom_ref FROM taxonomy WHERE id = 8), 'New kingdom_ref of unit 8: 14');
SELECT ok(to_tsvector('simple', 'D') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 8), 'New kingdom_indexed of unit 8: d');
SELECT ok(15 = (SELECT phylum_ref FROM taxonomy WHERE id = 8), 'New phylum_ref of unit 8: 15');
SELECT ok(to_tsvector('simple', 'DA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 8), 'New phylum_indexed of unit 8: da');
SELECT ok(16 = (SELECT class_ref FROM taxonomy WHERE id = 8), 'New class_ref of unit 8: 16');
SELECT ok(to_tsvector('simple', 'DAA') = (SELECT class_indexed FROM taxonomy WHERE id = 8), 'New class_indexed of unit 8: daa');
SELECT ok(14 = (SELECT kingdom_ref FROM taxonomy WHERE id = 9), 'New kingdom_ref of unit 9: 14');
SELECT ok(to_tsvector('simple', 'D') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 9), 'New kingdom_indexed of unit 9: d');
SELECT ok(15 = (SELECT phylum_ref FROM taxonomy WHERE id = 9), 'New phylum_ref of unit 9: 15');
SELECT ok(to_tsvector('simple', 'DA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 9), 'New phylum_indexed of unit 9: da');
SELECT ok(16 = (SELECT class_ref FROM taxonomy WHERE id = 9), 'New class_ref of unit 9: 16');
SELECT ok(to_tsvector('simple', 'DAA') = (SELECT class_indexed FROM taxonomy WHERE id = 9), 'New class_indexed of unit 9: daa');
SELECT ok(14 = (SELECT kingdom_ref FROM taxonomy WHERE id = 10), 'New kingdom_ref of unit 10: 14');
SELECT ok(to_tsvector('simple', 'D') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 10), 'New kingdom_indexed of unit 10: d');
SELECT ok(15 = (SELECT phylum_ref FROM taxonomy WHERE id = 10), 'New phylum_ref of unit 10: 15');
SELECT ok(to_tsvector('simple', 'DA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 10), 'New phylum_indexed of unit 10: da');
SELECT ok(16 = (SELECT class_ref FROM taxonomy WHERE id = 10), 'New class_ref of unit 10: 16');
SELECT ok(to_tsvector('simple', 'DAA') = (SELECT class_indexed FROM taxonomy WHERE id = 10), 'New class_indexed of unit 10: daa');
...
SELECT ok(to_tsvector('simple', 'E') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 6), 'New kingdom_indexed of unit 6: e');
SELECT ok(18 = (SELECT phylum_ref FROM taxonomy WHERE id = 6), 'New phylum_ref of unit 6: 18');
SELECT ok(to_tsvector('simple', 'EA') = (SELECT phylum_indexed FROM taxonomy WHERE id = 6), 'New phylum_indexed of unit 6: ea');
SELECT ok(19 = (SELECT class_ref FROM taxonomy WHERE id = 6), 'New class_ref of unit 6: 19');
SELECT ok(to_tsvector('simple', 'EAA') = (SELECT class_indexed FROM taxonomy WHERE id = 6), 'New class_indexed of unit 6: eaa');
SELECT ok(20 = (SELECT order_ref FROM taxonomy WHERE id = 6), 'New class_ref of unit 6: 20');
SELECT ok(to_tsvector('simple', 'EAAA') = (SELECT order_indexed FROM taxonomy WHERE id = 6), 'New class_indexed of unit 6: eaaa');
SELECT ok(8 = (SELECT sub_genus_ref FROM taxonomy WHERE id = 9), 'New sub_genus_ref of unit 9: 8');
SELECT ok(to_tsvector('simple', 'AAAAAAA') = (SELECT sub_genus_indexed FROM taxonomy WHERE id = 9), 'New sub_genus_indexed of unit 9: aaaaaaa');
...
SELECT ok(to_tsvector('simple', 'AAAAAAA') = (SELECT genus_indexed FROM taxonomy WHERE id = 8), 'New genus_indexed of unit 8: aaaaaaa');
...
SELECT ok(to_tsvector('simple', 'AAAAAAA') = (SELECT genus_indexed FROM taxonomy WHERE id = 9), 'New genus_indexed of unit 9: aaaaaaa');
SELECT ok(9 = (SELECT species_ref FROM taxonomy WHERE id = 9), 'New species_ref of unit 9: 9');
SELECT ok(to_tsvector('simple', 'AAAAAAAA') = (SELECT species_indexed FROM taxonomy WHERE id = 9), 'New species_indexed of unit 9: aaaaaaaa');
...
SELECT ok(to_tsvector('simple', 'GENUSDUB') = (SELECT genus_indexed FROm taxonomy WHERE id = 29), 'New genus_indexed of unit 29: genusdub');
SELECT ok(29 = (SELECT sub_genus_ref FROM taxonomy WHERE id = 29), 'New sub_genus_ref of unit 29: 29');
SELECT ok(to_tsvector('simple', 'NEOSUBGENUS') = (SELECT sub_genus_indexed FROM taxonomy WHERE id = 29), 'New sub_genus_indexed of unit 29: neosubgenus');
...
SELECT ok(to_tsvector('simple', 'GENUSDUB') = (SELECT genus_indexed FROM taxonomy WHERE id = 30), 'New genus_indexed of unit 30: genusdub');
SELECT ok(29 = (SELECT sub_genus_ref FROM taxonomy WHERE id = 30), 'New sub_genus_ref of unit 30: 29');
SELECT ok(to_tsvector('simple', 'NEOSUBGENUS') = (SELECT sub_genus_indexed FROM taxonomy WHERE id = 30), 'New sub_genus_indexed of unit 30: neosubgenus');
...
SELECT ok(to_tsvector('simple', 'SERIE') = (SELECT serie_indexed FROM taxonomy WHERE id = 30), 'New serie_indexed of unit 30: serie');
...
SELECT ok(to_tsvector('simple', 'GENUSDUB') = (SELECT genus_indexed FROm taxonomy WHERE id = 32), 'New genus_indexed of unit 32: genusdub');
SELECT ok(29 = (SELECT sub_genus_ref FROM taxonomy WHERE id = 32), 'New sub_genus_ref of unit 32: 29');
SELECT ok(to_tsvector('simple', 'NEOSUBGENUS') = (SELECT sub_genus_indexed FROM taxonomy WHERE id = 32), 'New sub_genus_indexed of unit 32: neosubgenus');
...
SELECT ok(to_tsvector('simple', 'SERIE') = (SELECT serie_indexed FROM taxonomy WHERE id = 32), 'New serie_indexed of unit 32: serie');
SELECT ok(31 = (SELECT super_species_ref FROM taxonomy WHERE id = 32), 'New super_species_ref of unit 32: 31');
SELECT ok(to_tsvector('simple', 'SUPERSPECIES') = (SELECT super_species_indexed FROM taxonomy WHERE id = 32), 'New super_species_indexed of unit 32: superspecies');
SELECT ok(32 = (SELECT species_ref FROM taxonomy WHERE id = 32), 'New species_ref of unit 32: 32');
SELECT ok(to_tsvector('simple', 'SPECIES') = (SELECT species_indexed FROM taxonomy WHERE id = 32), 'New species_indexed of unit 32: species');
...
SELECT ok(to_tsvector('simple', 'THEDOMAIN') = (SELECT domain_indexed FROM taxonomy WHERE id = 40), 'New domain_indexed of unit 40: thedomain');
SELECT ok(35 = (SELECT kingdom_ref FROM taxonomy WHERE id = 40), 'New kingdom_ref of unit 40: 35');
SELECT ok(to_tsvector('simple', 'THEKINGDOM') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 40), 'New kingdom_indexed of unit 40: thekingdom');
SELECT ok(36 = (SELECT super_phylum_ref FROM taxonomy WHERE id = 40), 'New super_phylum_ref of unit 40: 36');
SELECT ok(to_tsvector('simple', 'THESUPERPHYL') = (SELECT super_phylum_indexed FROM taxonomy WHERE id = 40), 'New super_phylum_indexed of unit 40: thesuperphyl');
SELECT ok(43 = (SELECT phylum_ref FROM taxonomy WHERE id = 40), 'New phylum_ref of unit 40: 43');
SELECT ok(to_tsvector('simple', 'THESECPHYLUM') = (SELECT phylum_indexed FROM taxonomy WHERE id = 40), 'New phylum_indexed of unit 40: thesecphylum');
SELECT ok(40 = (SELECT sub_phylum_ref FROM taxonomy WHERE id = 40), 'New sub_phylum_ref of unit 40: 40');
SELECT ok(to_tsvector('simple', 'THESUBCOHORTBOTANY') = (SELECT sub_phylum_indexed FROM taxonomy WHERE id = 40), 'New sub_phylum_indexed of unit 40: thesubcohortbotany');
...
SELECT ok(to_tsvector('simple', 'THEDOMAIN') = (SELECT domain_indexed FROM taxonomy WHERE id = 41), 'New domain_indexed of unit 41: thedomain');
SELECT ok(35 = (SELECT kingdom_ref FROM taxonomy WHERE id = 41), 'New kingdom_ref of unit 41: 35');
SELECT ok(to_tsvector('simple', 'THEKINGDOM') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 41), 'New kingdom_indexed of unit 41: thekingdom');
SELECT ok(36 = (SELECT super_phylum_ref FROM taxonomy WHERE id = 41), 'New super_phylum_ref of unit 41: 36');
SELECT ok(to_tsvector('simple', 'THESUPERPHYL') = (SELECT super_phylum_indexed FROM taxonomy WHERE id = 41), 'New super_phylum_indexed of unit 41: thesuperphyl');
SELECT ok(43 = (SELECT phylum_ref FROM taxonomy WHERE id = 41), 'New phylum_ref of unit 41: 43');
SELECT ok(to_tsvector('simple', 'THESECPHYLUM') = (SELECT phylum_indexed FROM taxonomy WHERE id = 41), 'New phylum_indexed of unit 41: thesecphylum');
SELECT ok(40 = (SELECT sub_phylum_ref FROM taxonomy WHERE id = 41), 'New sub_phylum_ref of unit 41: 40');
SELECT ok(to_tsvector('simple', 'THESUBCOHORTBOTANY') = (SELECT sub_phylum_indexed FROM taxonomy WHERE id = 41), 'New sub_phylum_indexed of unit 41: thesubcohortbotany');
...
SELECT ok(to_tsvector('simple', 'THESUPERCLASS') = (SELECT super_class_indexed FROM taxonomy WHERE id = 41), 'New super_class_indexed of unit 41: thesuperclass ');
...
SELECT ok(to_tsvector('simple', 'THEDOMAIN') = (SELECT domain_indexed FROM taxonomy WHERE id = 42), 'New domain_indexed of unit 42: thedomain');
SELECT ok(35 = (SELECT kingdom_ref FROM taxonomy WHERE id = 42), 'New kingdom_ref of unit 42: 35');
SELECT ok(to_tsvector('simple', 'THEKINGDOM') = (SELECT kingdom_indexed FROM taxonomy WHERE id = 42), 'New kingdom_indexed of unit 42: thekingdom');
SELECT ok(36 = (SELECT super_phylum_ref FROM taxonomy WHERE id = 42), 'New super_phylum_ref of unit 42: 36');
SELECT ok(to_tsvector('simple', 'THESUPERPHYL') = (SELECT super_phylum_indexed FROM taxonomy WHERE id = 42), 'New super_phylum_indexed of unit 42: thesuperphyl');
SELECT ok(43 = (SELECT phylum_ref FROM taxonomy WHERE id = 42), 'New phylum_ref of unit 42: 43');
SELECT ok(to_tsvector('simple', 'THESECPHYLUM') = (SELECT phylum_indexed FROM taxonomy WHERE id = 42), 'New phylum_indexed of unit 42: thesecphylum');
SELECT ok(40 = (SELECT sub_phylum_ref FROM taxonomy WHERE id = 42), 'New sub_phylum_ref of unit 42: 40');
SELECT ok(to_tsvector('simple', 'THESUBCOHORTBOTANY') = (SELECT sub_phylum_indexed FROM taxonomy WHERE id = 42), 'New sub_phylum_indexed of unit 42: thesubcohortbotany');
...
SELECT ok(to_tsvector('simple', 'THESUPERCLASS') = (SELECT super_class_indexed FROM taxonomy WHERE id = 42), 'New super_class_indexed of unit 42: thesuperclass ');
SELECT ok(42 = (SELECT class_ref FROM taxonomy WHERE id = 42), 'New class_ref of unit 42: 42');
SELECT ok(to_tsvector('simple', 'THECLASS') = (SELECT class_indexed FROM taxonomy WHERE id = 42), 'New class_indexed of unit 42: theclass ');
...
VALUES (3,6, true, 'sdf', 'doesfdjohn', to_tsvector('simple', 'sd'), 'qsd', 'qsd', DATE 'June 20, 1989', 'M',DATE 'January 1, 0000');
...
insert into people (id,db_people_type, is_physical, formated_name, formated_name_indexed, formated_name_ts, family_name, given_name, birth_date, gender, end_date) 
VALUES (4,6, true, 'Doe Jsssohn', 'sssss', to_tsvector('simple', 'Doe qsdqsd'), 'Dssoe', 'Johdn', DATE 'June 20, 1979', 'M', DATE 'January 1, 0000');
