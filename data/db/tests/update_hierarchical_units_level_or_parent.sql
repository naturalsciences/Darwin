...
VALUES (3,6, true, 'sdf', 'doesfdjohn', to_tsvector('simple', 'sd'), 'qsd', 'qsd', DATE 'June 20, 1989', 'M',DEFAULT);
...
insert into people (id,db_people_type, is_physical, formated_name, formated_name_indexed, formated_name_ts, family_name, given_name, birth_date, gender, end_date) 
VALUES (4,6, true, 'Doe Jsssohn', 'sssss', to_tsvector('simple', 'Doe qsdqsd'), 'Dssoe', 'Johdn', DATE 'June 20, 1979', 'M', DEFAULT);
