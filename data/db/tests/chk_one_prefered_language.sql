...
SELECT ok(fct_chk_one_pref_language(1, true), 'Table people_languages. No preferred language yet -> is ok');
SELECT ok(fct_chk_one_pref_language(1, false), 'Table people languages. No preferred language yet -> is ok');
SELECT ok(fct_chk_one_pref_language(1, true, 'users'), 'Table users_languages. No preferred language yet -> is ok');
SELECT ok(fct_chk_one_pref_language(1, false, 'users'), 'Table users_languages. No preferred language yet -> is ok');

SELECT lives_ok('INSERT INTO people_languages (people_ref) VALUES (1)', 'People: First data and not a preferred language -> should return ok');
SELECT lives_ok('INSERT INTO users_languages (users_ref) VALUES (1)', 'Users: First data and not a preferred language -> should return ok');
...
SELECT lives_ok('INSERT INTO people_languages (people_ref, language_country, preferred_language) VALUES (1, ''fr_be'', true)', 'People: First preferred language inserted -> should be ok');
SELECT lives_ok('INSERT INTO users_languages (users_ref, language_country, preferred_language) VALUES (1, ''fr_be'', true)', 'Users: First preferred language inserted -> should be ok');

SELECT ok(not fct_chk_one_pref_language(1, true), 'Table people_languages. One preferred language yet -> should not be ok');
SELECT ok(fct_chk_one_pref_language(1, false), 'Table people languages. One preferred language yet -> should be ok');
SELECT ok(not fct_chk_one_pref_language(1, true, 'users'), 'Table users_languages. One preferred language yet -> should not be ok');
SELECT ok(fct_chk_one_pref_language(1, false, 'users'), 'Table users_languages. One preferred language yet -> should be ok');
