...
SELECT ok(0 = (SELECT COALESCE(code_num, 0) FROM codes WHERE referenced_relation = 'specimens' AND record_id = 4 AND code_category = 'main'), 'A NULL has been effectively set for code 124bis');
