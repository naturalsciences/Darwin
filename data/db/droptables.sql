...
DROP SEQUENCE IF EXISTS users_tables_fields_tracked_id_seq  CASCADE;
DROP SEQUENCE IF EXISTS users_tracking_id_seq  CASCADE;
DROP SEQUENCE IF EXISTS users_tracking_records_id_seq  CASCADE;
DROP SEQUENCE IF EXISTS collection_maintenance_id_seq  CASCADE;
DROP SEQUENCE IF EXISTS my_saved_searches_id_seq  CASCADE;
DROP SEQUENCE IF EXISTS my_preferences_id_seq  CASCADE;
DROP SEQUENCE IF EXISTS my_saved_specimens_id_seq  CASCADE;
