...
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (1,1, 'taxonomy', 'domain', 'domain', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (2,2, 'taxonomy', 'kingdom', 'kingdom', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (3,3, 'taxonomy', 'super phylum', 'super_phylum', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (4,4, 'taxonomy', 'phylum', 'phylum', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (5,5, 'taxonomy', 'sub phylum', 'sub_phylum', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (6,6, 'taxonomy', 'infra phylum', 'infra_phylum', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (7,7, 'taxonomy', 'super cohort - botany', 'super_cohort_botany', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (8,8, 'taxonomy', 'cohort - botany', 'cohort_botany', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (9,9, 'taxonomy', 'sub cohort - botany', 'sub_cohort_botany', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (10,10, 'taxonomy', 'infra cohort - botany', 'infra_cohort_botany', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (11,11, 'taxonomy', 'super class', 'super_class', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (12,12, 'taxonomy', 'class', 'class', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (13,13, 'taxonomy', 'sub class', 'sub_class', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (14,14, 'taxonomy', 'infra class', 'infra_class', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (15,15, 'taxonomy', 'super division', 'super_division', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (16,16, 'taxonomy', 'division', 'division', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (17,17, 'taxonomy', 'sub division', 'sub_division', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (18,18, 'taxonomy', 'infra division', 'infra_division', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (19,19, 'taxonomy', 'super legion', 'super_legion', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (20,20, 'taxonomy', 'legion', 'legion', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (21,21, 'taxonomy', 'sub legion', 'sub_legion', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (22,22, 'taxonomy', 'infra legion', 'infra_legion', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (23,23, 'taxonomy', 'super cohort - zoology', 'super_cohort_zoology', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (24,24, 'taxonomy', 'cohort - zoology', 'cohort_zoology', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (25,25, 'taxonomy', 'sub cohort - zoology', 'sub_cohort_zoology', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (26,26, 'taxonomy', 'infra cohort - zoology', 'infra_cohort_zoology', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (27,27, 'taxonomy', 'super order', 'super_order', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (28,28, 'taxonomy', 'order', 'order', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (29,29, 'taxonomy', 'sub order', 'sub_order', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (30,30, 'taxonomy', 'infra order', 'infra_order', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (31,31, 'taxonomy', 'section - zoology', 'section_zoology', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (32,32, 'taxonomy', 'sub section - zoology', 'sub_section_zoology', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (33,33, 'taxonomy', 'super family', 'super_family', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (34,34, 'taxonomy', 'family', 'family', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (35,35, 'taxonomy', 'sub family', 'sub_family', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (36,36, 'taxonomy', 'infra family', 'infra_family', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (37,37, 'taxonomy', 'super tribe', 'super_tribe', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (38,38, 'taxonomy', 'tribe', 'tribe', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (39,39, 'taxonomy', 'sub tribe', 'sub_tribe', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (40,40, 'taxonomy', 'infra tribe', 'infra_tribe', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (41,41, 'taxonomy', 'genus', 'genus', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (42,42, 'taxonomy', 'sub genus', 'sub_genus', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (43,43, 'taxonomy', 'section - botany', 'section_botany', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (44,44, 'taxonomy', 'sub section - botany', 'sub_section_botany', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (45,45, 'taxonomy', 'serie', 'serie', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (46,46, 'taxonomy', 'sub serie', 'sub_serie', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (47,47, 'taxonomy', 'super species', 'super_species', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (48,48, 'taxonomy', 'species', 'species', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (49,49, 'taxonomy', 'sub species', 'sub_species', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (50,50, 'taxonomy', 'variety', 'variety', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (51,51, 'taxonomy', 'sub variety', 'sub_variety', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (52,52, 'taxonomy', 'form', 'form', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (53,53, 'taxonomy', 'sub form', 'sub_form', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (54,54, 'taxonomy', 'abberans', 'abberans', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (55,55, 'chronostratigraphy', 'eon', 'eon', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (56,56, 'chronostratigraphy', 'era', 'era', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (57,57, 'chronostratigraphy', 'sub era', 'sub_era', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (58,58, 'chronostratigraphy', 'system', 'system', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (59,59, 'chronostratigraphy', 'serie', 'serie', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (60,60, 'chronostratigraphy', 'stage', 'stage', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (61,61, 'chronostratigraphy', 'sub stage', 'sub_stage', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (62,62, 'chronostratigraphy', 'sub level 1', 'sub_level_1', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (63,63, 'chronostratigraphy', 'sub level 2', 'sub_level_2', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (64,64, 'lithostratigraphy', 'group', 'group', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (65,65, 'lithostratigraphy', 'formation', 'formation', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (66,66, 'lithostratigraphy', 'member', 'member', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (67,67, 'lithostratigraphy', 'layer', 'layer', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (68,68, 'lithostratigraphy', 'sub level 1', 'sub_level_1', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (69,69, 'lithostratigraphy', 'sub level 2', 'sub_level_2', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (70,70, 'mineralogy', 'class', 'unit_class', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (71,71, 'mineralogy', 'sub_class', 'unit_sub_class', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (72,72, 'mineralogy', 'series', 'unit_series', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (73,73, 'mineralogy', 'variety', 'unit_variety', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (75,75, 'lithology', 'main group', 'unit_main_group', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (76,76, 'lithology', 'group', 'unit_group', false);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (77,77, 'lithology', 'sub group', 'unit_sub_group', true);
insert into catalogue_levels (id, level_type, level_name, level_sys_name, optional_level) values (78,78, 'lithology', 'rock', 'unit_rock', false);
