...
create table darwin_flat
  (
    ...
    CONSTRAINT fk_darwin_flat_collection_ref FOREIGN KEY (collection_ref) REFERENCES collections (id) ON DELETE SET DEFAULT,
    ...
    CONSTRAINT fk_darwin_flat_expedition_ref FOREIGN KEY (expedition_ref) REFERENCES expeditions (id) ON DELETE SET DEFAULT,
    CONSTRAINT fk_darwin_flat_gtu_ref FOREIGN KEY (gtu_ref) REFERENCES gtu (id) ON DELETE SET DEFAULT,
    CONSTRAINT fk_darwin_flat_gtu_parent_ref FOREIGN KEY (gtu_parent_ref) REFERENCES gtu (id) ON DELETE SET DEFAULT,
    CONSTRAINT fk_darwin_flat_taxon_ref FOREIGN KEY (taxon_ref) REFERENCES taxonomy (id) ON DELETE SET DEFAULT,
    CONSTRAINT fk_darwin_flat_taxon_parent_ref FOREIGN KEY (taxon_parent_ref) REFERENCES taxonomy (id) ON DELETE SET DEFAULT,
    CONSTRAINT fk_darwin_flat_taxon_level_ref FOREIGN KEY (taxon_level_ref) REFERENCES catalogue_levels (id) ON DELETE SET DEFAULT,
    CONSTRAINT fk_darwin_flat_chrono_ref FOREIGN KEY (chrono_ref) REFERENCES chronostratigraphy (id) ON DELETE SET DEFAULT,
    ...
    CONSTRAINT fk_darwin_flat_chrono_level_ref FOREIGN KEY (chrono_level_ref) REFERENCES catalogue_levels (id) ON DELETE SET DEFAULT,
    CONSTRAINT fk_darwin_flat_litho_ref FOREIGN KEY (litho_ref) REFERENCES lithostratigraphy (id) ON DELETE SET DEFAULT,
    ...
    CONSTRAINT fk_darwin_flat_litho_level_ref FOREIGN KEY (litho_level_ref) REFERENCES catalogue_levels (id) ON DELETE SET DEFAULT,
    CONSTRAINT fk_darwin_flat_lithology_ref FOREIGN KEY (lithology_ref) REFERENCES lithology (id) ON DELETE SET DEFAULT,
    ...
    CONSTRAINT fk_darwin_flat_lithology_level_ref FOREIGN KEY (lithology_level_ref) REFERENCES catalogue_levels (id) ON DELETE SET DEFAULT,
    CONSTRAINT fk_darwin_flat_mineral_ref FOREIGN KEY (mineral_ref) REFERENCES mineralogy (id) ON DELETE SET DEFAULT,
    ...
    CONSTRAINT fk_darwin_flat_mineral_level_ref FOREIGN KEY (mineral_level_ref) REFERENCES catalogue_levels (id) ON DELETE SET DEFAULT,
