...
create table darwin_flat
  (
    ...
    CONSTRAINT fk_darwin_flat_collection_parent_ref FOREIGN KEY (collection_parent_ref) REFERENCES collections (id) ON DELETE SET 0,
    ...
    CONSTRAINT fk_darwin_flat_gtu_parent_ref FOREIGN KEY (gtu_parent_ref) REFERENCES gtu (id) ON DELETE SET 0,
    CONSTRAINT fk_darwin_flat_taxon_ref FOREIGN KEY (taxon_ref) REFERENCES taxonomy (id) ON DELETE CASCADE,
    CONSTRAINT fk_darwin_flat_taxon_parent_ref FOREIGN KEY (taxon_parent_ref) REFERENCES taxonomy (id) ON DELETE SET 0,
    ...
    CONSTRAINT fk_darwin_flat_chrono_parent_ref FOREIGN KEY (chrono_parent_ref) REFERENCES chronostratigraphy (id) ON DELETE SET 0,
    ...
    CONSTRAINT fk_darwin_flat_litho_parent_ref FOREIGN KEY (litho_parent_ref) REFERENCES lithostratigraphy (id) ON DELETE SET 0,
    ...
    CONSTRAINT fk_darwin_flat_lithology_parent_ref FOREIGN KEY (lithology_parent_ref) REFERENCES lithology (id) ON DELETE SET 0,
    ...
    CONSTRAINT fk_darwin_flat_mineral_parent_ref FOREIGN KEY (mineral_parent_ref) REFERENCES mineralogy (id) ON DELETE SET 0,
    ...
    CONSTRAINT fk_darwin_flat_host_taxon_ref FOREIGN KEY (host_taxon_ref) REFERENCES taxonomy (id) ON DELETE SET 0,
    CONSTRAINT fk_darwin_flat_host_taxon_parent_ref FOREIGN KEY (host_taxon_parent_ref) REFERENCES taxonomy (id) ON DELETE SET 0,
    CONSTRAINT fk_darwin_flat_host_taxon_level_ref FOREIGN KEY (host_taxon_level_ref) REFERENCES catalogue_levels (id) ON DELETE SET 0,
