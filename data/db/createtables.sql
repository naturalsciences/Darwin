...
create table specimen_individuals
       (
        ...
        type_group varchar not null default '',
        type_search varchar not null default '',
...
create table darwin_flat
  (
    ...
    individual_type_group varchar not null default '',
    individual_type_search varchar not null default '',
