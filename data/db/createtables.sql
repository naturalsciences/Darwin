...
CREATE UNIQUE INDEX CONCURRENTLY unq_specimen_parts ON specimen_parts (specimen_individual_ref, specimen_part, coalesce("building", ''), coalesce("floor", ''), coalesce("room", ''), coalesce("row", ''), coalesce("shelf", ''), coalesce("container", ''), coalesce("sub_container", ''), specimen_status);
