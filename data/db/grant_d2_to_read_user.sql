 ...
 GRANT SELECT ON darwin2.catalogue_bibliography TO d2viewer;
 GRANT SELECT ON darwin2.bibliography TO d2viewer;
 GRANT SELECT ON darwin2.specimens_flat TO d2viewer;
 ...
 GRANT SELECT, INSERT ON darwin2.informative_workflow TO d2viewer;
 GRANT USAGE ON darwin2.informative_workflow_id_seq TO d2viewer;
