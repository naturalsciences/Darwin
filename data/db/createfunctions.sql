...
BEGIN
  IF OLD.taxon_ref IS DISTINCT FROM NEW.taxon_ref THEN
    ...
    INTO NEW.taxon_name, NEW.taxon_level_ref, NEW.taxon_level_name, NEW.taxon_status, NEW.taxon_local, NEW.taxon_color, NEW_taxon_parent_ref
  ...
  IF OLD.litho_ref IS DISTINCT FROM NEW.litho_ref THEN
    ...
    INTO NEW.litho_name, NEW.litho_level_ref, NEW.litho_level_name, NEW.litho_status, NEW.litho_local, NEW.litho_color, NEW_litho_parent_ref
  ...
  IF OLD.lithology_ref IS DISTINCT FROM NEW.lithology_ref THEN
    SELECT l.name, l.level_ref, cl.level_name, l.status, l.local_naming, l.color, l.parent_ref
    INTO NEW.lithology_name, NEW.lithology_level_ref, NEW.lithology_level_name, NEW.lithology_status, NEW.lithology_local, NEW.lithology_color, NEW_lithology_parent_ref
  ...
  IF OLD.mineral_ref IS DISTINCT FROM NEW.mineral_ref THEN
    ...
    INTO NEW.mineral_name, NEW.mineral_level_ref, NEW.mineral_level_name, NEW.mineral_status, NEW.mineral_local, NEW.mineral_color, NEW_mineral_parent_ref
