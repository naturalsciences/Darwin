...
DROP FUNCTION IF EXISTS fct_chk_one_pref_language(person people_languages.people_ref%TYPE, preferred people_languages.preferred_language%TYPE) CASCADE;
DROP FUNCTION IF EXISTS fct_chk_one_pref_language(person people_languages.people_ref%TYPE, preferred people_languages.preferred_language%TYPE, table_prefix varchar) CASCADE;
