...
DROP FUNCTION convert_to_real(character varying);
DROP FUNCTION fct_add_in_dict(text, text, text, text);
DROP FUNCTION fct_add_in_dict_dept(text, text, text, text, text, text);
DROP FUNCTION fct_del_in_dict(text, text, text, text);
DROP FUNCTION fct_del_in_dict_dept(text, text, text, text, text, text, text);
DROP FUNCTION fct_find_tax_level(text, integer);
DROP FUNCTION fct_chk_possible_upper_level(character varying, integer, integer, integer);
DROP FUNCTION fct_cpy_loan_history(integer);
DROP FUNCTION fct_cpy_volume_conversion(real, character varying);
DROP FUNCTION fct_cpy_weight_conversion(real, character varying);
DROP FUNCTION fct_look_for_institution(text);
DROP FUNCTION fct_remove_array_elem(anyarray, anyarray);
DROP FUNCTION get_import_row();
DROP FUNCTION getspecificparentforlevel(character varying, character varying, character varying);
DROP FUNCTION linetotagrowsformatconserved(text);
DROP FUNCTION touniquestr(character varying);