...
#### My File is loaded but I can't do anything
...
#### Darwin tells me it can't find the taxon/chrono/litho/mineral but this one really exists in Darwin !
...
#### When I edit my file there are no errors displayed

![Existing catalogue in error]({{ ASSET_PATH }}/../../images/import/import_no-error.png)
